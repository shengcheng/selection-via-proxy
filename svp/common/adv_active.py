...
from svp.common.adv_train import run_training
...
def generate_models(create_graph: CreateGraph,
    ...
    while True:
        ...
        # Run Training
        assert model is not None  # mypy hack
        model, accuracies, robustness, times = run_training(
            model=model,
            optimizer=optimizer,
            criterion=criterion,
            device=device,
        ...
        stats['train_robustness'] = robustness.train
        stats['dev_robustness'] = robustness.dev
        stats['test_robustness'] = robustness.test
